...
We are trying to keep backwards compatibility breaks in The Tool to an absolute minimum. Please take this into account when proposing changes.
...
- [General problems](https://github.com/the-tool/the-tool/issues)
